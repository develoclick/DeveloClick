export const dictionary = {
  es: {
    ...
    cotizador: {
      ...
      whatsappPlaceholder: "+51 987 654 321",
    ...
    contactoSection: {
      ...
      paragraph: "Escríbenos por el canal que prefieras. Respondemos en menos de 24 horas hábiles.",
      email: "Email",
      whatsapp: "WhatsApp",
      location: "Ubicación",
      schedule: "Agendar",
      scheduleValue: "Llamada estratégica 30min",
      ...
      successMessage: "Gracias{name}. Hemos recibido tu mensaje y nuestro equipo te contactará en menos de 24 horas hábiles.",
    },
    nosotrosHero: {
      badge: "Nosotros",
    ...
    nosotrosValores: {
      ...
      stats: [
        ...
        { value: "98%", label: "Clientes que renuevan" },
        { value: "24h", label: "Tiempo de respuesta" },
        { value: "6", label: "Fases de proceso probado" },
      ],
    },
    preciosHero: {
      badge: "Precios",
    ...
    legal: {
      ...
      privacySections: [
        ...
        },
        {
          ...
          body: "Puedes solicitar acceso, corrección o eliminación de tus datos personales en cualquier momento escribiéndonos a hola@develoclick.com.",
        },
        {
          heading: "5. Contacto",
          body: "Si tienes preguntas sobre esta política, contáctanos en hola@develoclick.com.",
        },
      ],
      ...
      termsSections: [
        ...
        {
          heading: "6. Contacto",
          body: "Para consultas sobre estos términos, escríbenos a hola@develoclick.com.",
        },
      ],
    },
  },
  en: {
    ...
    contactoSection: {
      ...
      paragraph: "Write to us on your preferred channel. We reply within 24 business hours.",
      email: "Email",
      whatsapp: "WhatsApp",
      location: "Location",
      schedule: "Book a call",
      scheduleValue: "30-min strategy call",
      ...
      successMessage: "Thank you{name}. We've received your message and our team will contact you within 24 business hours.",
    },
    nosotrosHero: {
      badge: "About us",
    ...
    nosotrosValores: {
      ...
      stats: [
        ...
        { value: "98%", label: "Clients who renew" },
        { value: "24h", label: "Response time" },
        { value: "6", label: "Proven process phases" },
      ],
    },
    preciosHero: {
      badge: "Pricing",
    ...
    testimonios: {
      ...
      paragraph: "Real businesses that trusted us to build their digital infrastructure.",
      items: [
        {
          quote: "DeveloClick understood our business before writing a single line of code. The result was a platform that tripled our conversions in three months.",
          name: "María Fernanda Ruiz",
          role: "CEO, Grupo Alaia",
        },
        {
          quote: "We moved from a generic website to a custom system. The post-launch support was as solid as the development itself.",
          name: "Diego Salazar",
          role: "Founder, Nortek Logistics",
        },
        {
          quote: "The 6-phase process completely removed the uncertainty. We knew exactly which stage we were in at all times.",
          name: "Camila Ibarra",
    ...
    legal: {
      ...
      privacySections: [
        ...
        },
        {
          ...
          body: "You can request access to, correction of, or deletion of your personal data at any time by writing to hola@develoclick.com.",
        },
        {
          heading: "5. Contact",
          body: "If you have questions about this policy, contact us at hola@develoclick.com.",
        },
      ],
      ...
      termsSections: [
        ...
        {
          heading: "6. Contact",
          body: "For questions about these terms, write to us at hola@develoclick.com.",
        },
      ],
    },
  },
