export const dictionary = {
  es: {
    ...
    hero: {
      badge: "Acelera el crecimiento de tu empresa",
      titleLine1: "Convierte más clientes con una",
      titleHighlight: "infraestructura digital",
      titleLine2: "que vende por ti.",
      subtitlePrefix: "En",
      subtitle:
        "diseñamos y desarrollamos soluciones tecnológicas robustas para que tu empresa facture más, automatice procesos y lidere su mercado sin fricciones técnicas.",
      checks: [
      ...
      stats: [
        ...
        { value: "100%", label: "Desarrollo a medida, cero plantillas" },
        { value: "2 min", label: "Lo que toma el cotizador" },
      ],
      trustLabel: "Tecnología de confianza para equipos que exigen resultados",
      floatingBadgeTitle: "Sin compromiso",
      floatingBadgeText: "La propuesta no te obliga",
      floatingBadge2Title: "Cero fricciones",
      floatingBadge2Text: "Soporte incluido",
    },
    tecnologias: {
      heading: "Tecnologías que impulsan tu negocio",
    },
    serviciosDestacados: {
      eyebrow: "Servicios",
      title1: "Lo que",
    ...
    carrusel: {
      ...
      title: "Convertimos retos de negocio en soluciones digitales.",
      prev: "Anterior",
      next: "Siguiente",
      slides: [
        {
          category: "Transformación digital",
          title: "Tecnología que conecta equipos y operaciones",
          description:
            "Creamos plataformas digitales que permiten optimizar procesos, mejorar la productividad y acelerar el crecimiento empresarial.",
          imageAlt: "Equipo corporativo trabajando con tecnología",
        },
        {
          category: "Desarrollo de software",
          title: "Software personalizado para negocios modernos",
          description:
            "Diseñamos y desarrollamos soluciones a medida adaptadas a tus objetivos, procesos internos y necesidades específicas.",
          imageAlt: "Programadores desarrollando software",
        },
        {
          category: "SaaS y plataformas digitales",
          title: "Productos digitales listos para escalar",
          description:
            "Construimos aplicaciones SaaS robustas, rápidas y preparadas para acompañar el crecimiento de tu empresa.",
          imageAlt: "Dashboard de plataforma digital",
        },
        {
          category: "Diseño UX/UI",
          title: "Experiencias digitales simples y memorables",
          description:
            "Creamos interfaces modernas centradas en usuarios, combinando diseño, estrategia y tecnología.",
          imageAlt: "Diseñador creando interfaz digital",
        },
        {
          category: "Automatización empresarial",
          title: "Procesos inteligentes que ahorran tiempo",
          description:
            "Implementamos automatizaciones para reducir tareas repetitivas y mejorar la eficiencia operativa.",
    ...
    serviciosGrid: {
      ...
      paragraph:
        "Desde una landing page hasta una plataforma SaaS completa. Cubrimos cada etapa del ciclo digital de tu negocio.",
      selectedLabel: "Solución seleccionada",
      bullets: [
        "Estrategia, diseño y desarrollo en un solo equipo.",
        "Enfoque en conversión, claridad visual y resultados.",
        "Soluciones escalables para empresas que quieren crecer.",
      ],
      exploreCta: "Explorar más",
      quote: "Cada proyecto se adapta a tu negocio, no al revés.",
      services: {
        web: {
    ...
    diferenciales: {
      badge: "¿Por qué DeveloClick?",
      title1: "Diferenciales que",
      titleHighlight: "marcan",
      title2: "la diferencia.",
      paragraph:
        "No entregamos plantillas. Construimos soluciones digitales con un nivel de detalle técnico y visual que se nota.",
      bannerEyebrow: "Ejecución que se nota",
      bannerTitle1: "Donde la estrategia digital se vuelve",
      bannerTitleHighlight: "ventaja competitiva.",
      bannerParagraph:
    ...
    cotizador: {
      ...
      q3Subtitle: "Nos ayuda a dimensionar el alcance técnico y estratégico.",
      ...
      emailPlaceholder: "carlos@tuempresa.com",
      whatsappLabel: "Teléfono (opcional)",
      whatsappPlaceholder: "Solo si prefieres que te llamemos",
    ...
    contactoSection: {
      ...
      emailValue: "develoclick@gmail.com",
      ctaLabel: "Abrir el cotizador",
    },
    nosotrosHero: {
      badge: "Nosotros",
      title1: "La agencia detrás de la",
      titleHighlight: "infraestructura digital",
      title2: "de tu negocio.",
      subtitle:
    ...
    nosotrosValores: {
      ...
      stats: [
        ...
        { value: "6", label: "Fases de proceso definido" },
        { value: "2", label: "Idiomas del sitio" },
      ],
    },
    preciosHero: {
      badge: "Precios",
      title1: "Inversión clara,",
      titleHighlight: "sin sorpresas.",
      subtitle:
        "Planes diseñados según el alcance real de tu proyecto. Sin cuotas ocultas, sin plantillas: cada presupuesto se ajusta a lo que tu negocio necesita para crecer.",
    },
    preciosPlanes: {
      mostChosen: "Más elegido",
      perProject: "proyecto único",
      custom: "a medida",
      cta: "Solicitar cotización",
      footerNote: "¿No estás seguro de qué plan necesitas?",
      footerLink: "Usa el cotizador inteligente",
      footerRest: "y te orientamos en 2 minutos.",
      plans: [
        {
          name: "Starter",
          price: "$500 - $1,500",
        ...
        },
        {
          ...
          features: [
            ...
            "Integraciones (formularios, CRM, analítica)",
        ...
        },
        {
          ...
          features: [
            ...
            "Automatizaciones y APIs propias",
    ...
    serviciosHero: {
      ...
      titleHighlight: "escalar digitalmente.",
      subtitle:
        "Desde una landing page hasta una plataforma SaaS completa: diseñamos y construimos cada pieza de tu ecosistema digital con un mismo equipo.",
    },
    serviciosDetalle: {
    ...
    legal: {
      ...
      privacyIntro:
        "En DeveloClick respetamos tu privacidad. Este documento explica qué información recopilamos, cómo la usamos y qué derechos tienes sobre ella.",
      privacySections: [
        {
          heading: "1. Información que recopilamos",
          body: "Recopilamos los datos que nos proporcionas voluntariamente a través de nuestros formularios de contacto y cotización: nombre, correo electrónico, teléfono, empresa y detalles del proyecto que quieras compartir.",
        },
        {
          heading: "2. Uso de la información",
          body: "Usamos tus datos únicamente para responder a tu solicitud, preparar propuestas comerciales y, si nos autorizas, mantenerte informado sobre nuestros servicios. No vendemos ni compartimos tu información con terceros con fines comerciales.",
        },
        {
          heading: "3. Cookies y analítica",
          body: "Este sitio puede usar cookies técnicas y de analítica para entender cómo se usa la web y mejorar la experiencia. Puedes deshabilitarlas desde la configuración de tu navegador en cualquier momento.",
        },
        {
          heading: "4. Tus derechos",
          body: "Puedes solicitar acceso, corrección o eliminación de tus datos personales en cualquier momento escribiéndonos a develoclick@gmail.com.",
        },
        {
          heading: "5. Contacto",
          body: "Si tienes preguntas sobre esta política, contáctanos en develoclick@gmail.com.",
        },
      ],
      termsTitle: "Términos y Condiciones",
      termsIntro:
        "Al utilizar este sitio web y contratar nuestros servicios, aceptas los siguientes términos y condiciones.",
      termsSections: [
        {
          heading: "1. Servicios",
          body: "DeveloClick ofrece servicios de diseño y desarrollo web, software a medida, plataformas SaaS, dashboards y automatización de procesos. El alcance específico de cada proyecto se define en una propuesta o contrato individual.",
        },
        {
          heading: "2. Propuestas y presupuestos",
          body: "Los precios mostrados en este sitio son referenciales. El presupuesto final se define tras evaluar los requerimientos específicos de cada proyecto a través del cotizador o una consulta directa.",
        },
        {
          heading: "3. Propiedad intelectual",
          body: "Salvo acuerdo distinto por escrito, el código y los entregables finales se transfieren al cliente una vez completado el pago acordado. DeveloClick puede mostrar el proyecto como parte de su portafolio.",
        },
        {
          heading: "4. Limitación de responsabilidad",
          body: "DeveloClick no se hace responsable por pérdidas indirectas derivadas del uso de los productos digitales entregados, más allá de lo establecido en el contrato de servicio correspondiente.",
        },
        {
          heading: "5. Cambios en los términos",
          body: "Podemos actualizar estos términos ocasionalmente. Los cambios relevantes serán comunicados a través de este sitio.",
        },
        {
          heading: "6. Contacto",
          body: "Para consultas sobre estos términos, escríbenos a develoclick@gmail.com.",
        },
      ],
    },
  },
  en: {
    ...
    hero: {
      badge: "Accelerate your company's growth",
      titleLine1: "Convert more customers with a",
      titleHighlight: "digital infrastructure",
      titleLine2: "that sells for you.",
      subtitlePrefix: "At",
      subtitle:
        "we design and build robust technology solutions so your company sells more, automates processes, and leads its market without technical friction.",
      checks: [
      ...
      stats: [
        ...
        { value: "100%", label: "Custom build, zero templates" },
        { value: "2 min", label: "Time the quote builder takes" },
      ],
      trustLabel: "Trusted technology for teams that demand results",
      floatingBadgeTitle: "No commitment",
      floatingBadgeText: "The proposal ties you to nothing",
      floatingBadge2Title: "Zero friction",
      floatingBadge2Text: "Support included",
    },
    tecnologias: {
      heading: "Technologies that power your business",
    },
    serviciosDestacados: {
      eyebrow: "Services",
      title1: "What we",
      ...
      slides: [
        {
          ...
          title: "Technology that connects teams and operations",
          description:
            "We build digital platforms that streamline processes, boost productivity, and accelerate business growth.",
          imageAlt: "Corporate team working with technology",
        },
        {
          category: "Software development",
          title: "Custom software for modern businesses",
          description:
            "We design and develop tailored solutions adapted to your goals, internal processes, and specific needs.",
          imageAlt: "Developers building software",
        },
        {
          category: "SaaS & digital platforms",
          title: "Digital products ready to scale",
          description:
            "We build robust, fast SaaS applications ready to support your company's growth.",
          imageAlt: "Digital platform dashboard",
        },
        {
          category: "UX/UI design",
          title: "Simple, memorable digital experiences",
          description:
            "We create modern, user-centered interfaces that combine design, strategy, and technology.",
          imageAlt: "Designer creating a digital interface",
        },
        {
          category: "Business automation",
          title: "Smart processes that save time",
          description:
            "We implement automations that cut repetitive work and improve operational efficiency.",
    ...
    serviciosGrid: {
      ...
      paragraph:
        "From a landing page to a full SaaS platform. We cover every stage of your business's digital cycle.",
      selectedLabel: "Selected solution",
      bullets: [
        "Strategy, design, and development in one team.",
        "Focus on conversion, visual clarity, and results.",
        "Scalable solutions for businesses ready to grow.",
      ],
      exploreCta: "Explore more",
      quote: "Every project adapts to your business, not the other way around.",
      services: {
        web: {
    ...
    diferenciales: {
      badge: "Why DeveloClick?",
      title1: "Differences that",
      titleHighlight: "make the difference.",
      title2: "",
      paragraph:
        "We don't deliver templates. We build digital solutions with a level of technical and visual detail you can feel.",
      bannerEyebrow: "Execution that shows",
      bannerTitle1: "Where digital strategy becomes",
      bannerTitleHighlight: "competitive advantage.",
      bannerParagraph:
    ...
    cotizador: {
      steps: ["Type", "Goal", "Budget", "Urgency", "Details", "Summary"],
      ...
      q3Subtitle: "It helps us scope the technical and strategic approach.",
      ...
      emailLabel: "Email *",
      emailPlaceholder: "carlos@yourcompany.com",
      whatsappLabel: "Phone (optional)",
      whatsappPlaceholder: "Only if you prefer a call",
      ...
      summaryUrgency: "Urgency level",
      summaryContact: "Contact details",
      summaryDescription: "Description",
      submit: "Send quote request",
      back: "Back",
      continue: "Continue",
      editData: "Edit my details",
      errorMessage:
    ...
    contactoSection: {
      ...
      emailValue: "develoclick@gmail.com",
      ctaLabel: "Open the quote builder",
    },
    nosotrosHero: {
      badge: "About us",
      title1: "The agency behind your business's",
      titleHighlight: "digital infrastructure",
      title2: ".",
      subtitle:
    ...
    nosotrosValores: {
      ...
      stats: [
        ...
        { value: "6", label: "Defined process phases" },
        { value: "2", label: "Site languages" },
      ],
    },
    preciosHero: {
      badge: "Pricing",
      title1: "Clear investment,",
      titleHighlight: "no surprises.",
      subtitle:
        "Plans designed around your project's real scope. No hidden fees, no templates: every budget fits what your business needs to grow.",
    },
    preciosPlanes: {
      mostChosen: "Most chosen",
      perProject: "one-time project",
      custom: "custom",
      cta: "Request a quote",
      footerNote: "Not sure which plan you need?",
      footerLink: "Use the smart quote builder",
      footerRest: "and we'll guide you in 2 minutes.",
      plans: [
        {
          name: "Starter",
          price: "$500 - $1,500",
        ...
        },
        {
          ...
          features: [
            ...
            "Automations and proprietary APIs",
    ...
    serviciosHero: {
      ...
      titleHighlight: "scale digitally.",
      subtitle:
        "From a landing page to a full SaaS platform: we design and build every piece of your digital ecosystem with one team.",
    },
    serviciosDetalle: {
    ...
    testimonios: {
      ...
      title1: "What you can expect",
      titleHighlight: "when you work with us.",
      paragraph:
        "Every project is a chance to prove our commitment to quality, innovation, and transparency. We build digital solutions designed to drive your company's growth.",
      items: [
        {
          title: "Built to measure",
          description:
            "We study your business before writing a single line of code, so the solution answers your actual goals instead of a generic template.",
        },
        {
          title: "Transparent communication",
          description:
            "You keep visibility over the project at every stage, with a clear methodology, organized deliveries, and constant follow-up.",
        },
        {
          title: "Quality built to grow",
          description:
            "We apply solid architecture, UX, and development practices to deliver software that is modern, secure, and ready to scale.",
        },
      ],
      cardTag: "DeveloClick commitment",
      bottomTitle: "We don't just build software.",
      bottomParagraph:
        "We build digital tools that help companies sell more, streamline operations, and grow with modern, scalable technology designed for what comes next.",
    },
    trustBar: {
      label: "Companies that already scaled with us",
    },
    theme: {
    ...
    legal: {
      ...
      privacyIntro:
        "At DeveloClick we respect your privacy. This document explains what information we collect, how we use it, and what rights you have over it.",
      privacySections: [
        {
          heading: "1. Information we collect",
          body: "We collect the data you voluntarily provide through our contact and quote forms: name, email, phone, company, and any project details you choose to share.",
        },
        {
          heading: "2. How we use your information",
          body: "We use your data solely to respond to your request, prepare business proposals, and, if you authorize it, keep you informed about our services. We do not sell or share your information with third parties for commercial purposes.",
        },
        {
          heading: "3. Cookies and analytics",
          body: "This site may use technical and analytics cookies to understand how the site is used and improve the experience. You can disable them from your browser settings at any time.",
        },
        {
          heading: "4. Your rights",
          body: "You can request access to, correction of, or deletion of your personal data at any time by writing to develoclick@gmail.com.",
        },
        {
          heading: "5. Contact",
          body: "If you have questions about this policy, contact us at develoclick@gmail.com.",
        },
      ],
      termsTitle: "Terms & Conditions",
      termsIntro:
        "By using this website and hiring our services, you agree to the following terms and conditions.",
      termsSections: [
        {
          heading: "1. Services",
          body: "DeveloClick offers web design and development, custom software, SaaS platforms, dashboards, and process automation services. The specific scope of each project is defined in an individual proposal or contract.",
        },
        {
          heading: "2. Proposals and quotes",
          body: "Prices shown on this site are for reference only. The final budget is defined after evaluating the specific requirements of each project through the quote builder or a direct consultation.",
        },
        {
          heading: "3. Intellectual property",
          body: "Unless otherwise agreed in writing, code and final deliverables are transferred to the client once the agreed payment is completed. DeveloClick may showcase the project as part of its portfolio.",
        },
        {
          heading: "4. Limitation of liability",
          body: "DeveloClick is not liable for indirect losses arising from the use of the delivered digital products, beyond what is established in the corresponding service agreement.",
        },
        {
          heading: "5. Changes to these terms",
          body: "We may update these terms occasionally. Relevant changes will be communicated through this site.",
        },
        {
          heading: "6. Contact",
          body: "For questions about these terms, write to us at develoclick@gmail.com.",
        },
      ],
    },
  },
