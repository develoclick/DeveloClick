...
export default function ServiciosDetalle() {
  const { t } = useLanguage();
  const servicios = t.serviciosDetalle.servicios.map((s, index) => ({
    ...s,
    image: images[index],
  }));
          ...
          return (
            ...
            >
              <div className={reversed ? "lg:order-2" : ""}>
                <div className="relative overflow-hidden rounded-3xl border border-white shadow-2xl aspect-[4/3]">
                  <Image
                    src={servicio.image}
              ...
              <div className={reversed ? "lg:order-1" : ""}>
                ...
                <Link
                  href="/#cotizador"
                  className="mt-8 inline-flex items-center gap-2 rounded-3xl bg-[#07182D] dark:bg-brand-red-600 px-6 py-4 text-sm font-bold text-white elev-2 transition-transform hover:-translate-y-0.5"
                >
